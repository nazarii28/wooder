...
window.addEventListener('load', function(){
  ...
  var touchsurface = document.getElementById('touchsurface'),
      ...
      allowedTime = 400, // максимальное время прохождения установленного расстояния
      elapsedTime,
      startTime
  ...
  function handleswipe(isrightswipe){
      if (isrightswipe) {
        ...
        iconMenu.classList.add("_active");
          ...
          console.log('Пролистывания в правую сторону не обнаружено.')
      }
  }
...
let mySliderNum = document.querySelector('.num');
let mySliderCurrent = document.querySelector('.swiper-slide-active');



slider_about.on('slideChange', function () {
	let currentSlide = ++slider_about.realIndex;
	mySliderNum.innerHTML = "0" + currentSlide;
})